...
def plot_all(sol,sol2,sol3,name,index=0):
	#Plot results
	...
	ax[0].plot(-sol.get_strain().T[0],-sol.get_stress().T[0],label='$C_1$ = 5.0',ls='--',color='c')
	ax[0].plot(-sol2.get_strain().T[0],-sol2.get_stress().T[0],label='$C_1$ = 10.0',ls='--',color='g')
	ax[0].plot(-sol3.get_strain().T[0],-sol3.get_stress().T[0],label='$C_1$ = 15.0',ls='--',color='b')
	commonFormat(ax[0],0.,0.,'upper left')
	ax[0].set_xlabel('$E_{zz}$')
	ax[0].set_ylabel('$S_{zz}$ (kPa)')
	...
	ax[1].plot(sol.get_time(),-sol.get_stress().T[0],ls='--',label='$C_1$ = 5.0',color='c')
	ax[1].plot(sol2.get_time(),-sol2.get_stress().T[0],ls='--',label='$C_1$ = 10.0',color='g')
	ax[1].plot(sol3.get_time(),-sol3.get_stress().T[0],ls='--',label='$C_1$ = 15.0',color='b')
	commonFormat(ax[1],0.,0.,'upper right')
	ax[1].set_xlabel('$Time$ (min)')
	ax[1].set_ylabel('$S_{zz}$ (kPa)')
	#
	#time-strain
...
material1 = set_material(5.,500.0,0.,  0.0001,0.0001,0.0,0.001,0.0001,0.0001,0.0,0.001, 50., 500.,  0., 0.1)
material2 = set_material(10.,500.0,0.,  0.0001,0.0001,0.0,0.001,0.0001,0.0001,0.0,0.001, 50., 500.,  0., 0.1)
material3 = set_material(15.,500.0,0.,  0.0001,0.0001,0.0,0.001,0.0001,0.0001,0.0,0.001, 50., 500.,  0., 0.1)
...
plot_all(sol1,sol2,sol3,"ch6_para_ep_c1.pdf",1)
