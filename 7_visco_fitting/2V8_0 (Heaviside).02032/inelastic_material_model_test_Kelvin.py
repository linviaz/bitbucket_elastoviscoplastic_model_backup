...
def plot_all(sol,name,index=0):
	...
	ax[0].plot(-exp_strain11,-sol.get_stress().T[0],label='Numerical ',ls='--',color='b')
	...
	commonFormat(ax[1],0.,0.,'upper left')
	...
	ax[2].plot(sol.get_time(),-exp_strain11,ls='--',label='Numerical',color='b')
...
plot_all(sol1,"ch6_para_vep_2V8_Hvsd.pdf",1)
