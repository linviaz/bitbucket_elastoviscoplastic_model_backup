...
def plot_all(sol,name,index=0):
	...
	ax.plot(np.log(sol.get_time()),-sol.get_strain().T[0],ls='--',label='Numerical',color='b')
	...
	commonFormat(ax,0.,0.,'lower right') #[0]
	ax.set_xlabel('$log(Time) (min)$')
	ax.set_ylabel('$E_{11}$')
...
material1 = set_material(9.0,500.0,0.0, 8.,500.,0.0,13000.,40.,500.,0.0,500., 70., 500., 00., 0.1)
...
plot_all(sol1,"ch6_para_vep_creep.pdf",1)
